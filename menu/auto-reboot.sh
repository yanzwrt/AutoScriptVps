...
echo -e "\e[1;35m 8 \e[0m Lihat reboot log"
echo -e "\e[1;35m 9 \e[0m Hapus reboot log"
echo -e ""
...
echo " Auto Reboot Log sukses di Hapus! \e[0m"
echo -e ""
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo ""
read -n 1 -s -r -p "tekan apasaja untuk kembali ke menu"
...
clear
echo ""
echo "Perintah Tidak ditemukan di menu"
echo ""
read -n 1 -s -r -p "tekan apasaja untuk kembali ke menu"
auto-reboot 
fi
